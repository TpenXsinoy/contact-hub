...
namespace ContactHubApi.Dtos.Users
{
    public class UserCreationDto
    {
        ...
        [MinLength(2, ErrorMessage = "Minimum lenghth for the first name is 2 characters.")]
        public string FirstName { get; set; } = string.Empty;

        [Required(ErrorMessage = "Last Name is required.")]
        [MaxLength(50, ErrorMessage = "Maximum lenghth for the last name is 50 characters.")]
        [MinLength(2, ErrorMessage = "Minimum lenghth for the last name is 2 characters.")]
        ...
        [MinLength(5, ErrorMessage = "Minimum lenghth for the username is 5 characters.")]
